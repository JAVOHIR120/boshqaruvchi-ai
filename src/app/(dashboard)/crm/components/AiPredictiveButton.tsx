...
import { Sparkles, X, TrendingUp, RefreshCw } from "lucide-react";
import ReactMarkdown from "react-markdown";

export default function AiPredictiveButton() {
        ...
        <>
            ...
            {isOpen && (
                <div style={{
                    ...
                    zIndex: 100,
                    display: "flex",
                    justifyContent: "flex-end", // Slide from right side like a cool dashboard widget
                    overflow: "hidden"
                }}>
                    <div style={{
                        width: "100%",
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginTop: "0.25rem" }}>AI orqali kelgusi sotuvlar tahlili</p>
                            </div>
                        ...
                        <div style={{ padding: "1.5rem", flex: 1, overflowY: "auto" }} className="ai-markdown-content">
                            {loading ? (
                                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", opacity: 0.7 }}>
                                    <RefreshCw size={40} className="animate-spin" color="#8b5cf6" style={{ animation: "spin 1s linear infinite", marginBottom: "1rem" }} />
                                    <p style={{ color: "#cbd5e1" }}>AI mijozlar bazangizni analiz qilmoqda...</p>
