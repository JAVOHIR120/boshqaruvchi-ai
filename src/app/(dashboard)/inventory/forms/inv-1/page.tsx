...
export default function Inv1Form() {
    const handlePrint = () => {
        window.print();
    };

    return (
        <PrintableWrapper title="INV-1 Shakl (4-ILOVA)" onPrint={handlePrint} orientation="landscape">
                ...
                <div style={{ width: "250px", marginLeft: "20px" }}>
                    <table className="a4-table" style={{ margin: 0, fontSize: "9pt" }}>
                        <tbody>
                            ...
                            <tr>
                                <td style={{ textAlign: "right" }}>INV-1-son shakl BHUT boʻyicha</td>
                                <td><input type="text" style={{ width: "100px" }} /></td>
                            </tr>
                            <tr>
            ...
            <div style={{ textAlign: "center", margin: "1.5rem 0" }}>
                <div style={{ display: "flex", justifyContent: "center", alignItems: "baseline" }}>
                    ...
                    <h3 style={{ fontSize: "12pt", fontWeight: "bold", marginLeft: "10px" }}>-sonli asosiy vositalarni inventarizatsiyadan oʻtkazish</h3>
                </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
                <div style={{ display: "flex", alignItems: "baseline", flex: 1 }}>
                    <span style={{ fontWeight: "bold" }}>Asosiy vositalar</span>
                    <input type="text" style={{ flex: 1, marginLeft: "10px" }} />
                </div>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "2rem" }}>
                <div style={{ display: "flex", alignItems: "baseline", flex: 1 }}>
                    <span style={{ fontWeight: "bold" }}>Joylashgan joyi</span>
                    <input type="text" style={{ flex: 1, marginLeft: "10px" }} />
                </div>
            </div>
            ...
            <div style={{ marginBottom: "2rem" }}>
                ...
                <p style={{ textIndent: "40px", textAlign: "justify" }}>
                    Inventarizatsiyani oʻtkazishni boshlanishiga asosiy vositalarga tegishli boʻlgan barcha chiqim va kirim hujjatlari buxgalteriya xizmatiga topshirildi va mening (bizning) javobgarligimga (javobgarligimizga) kelib tushgan hamma asosiy vositalar kirim qilingan, chiqib ketganlari xarajatga chiqim qilingan.
                </p>
                <p style={{ marginTop: "1rem" }}>Asosiy vositalarning saqlanishiga javobgar shaxs (shaxslar):</p>
            ...
            <table className="a4-table" style={{ width: "100%" }}>
                <thead>
                    <tr>
                        <th rowSpan={2}>T/r</th>
                        <th rowSpan={2}>Asosiy vositalarning nomi va qisqa tavsifi</th>
                        <th rowSpan={2}>Ishlab chiqarilgan (qurilgan) yili</th>
                        <th colSpan={3}>Raqami</th>
                        <th colSpan={2}>Haqiqiy borligi</th>
                        <th colSpan={2}>Buxgalteriya hisobi maʼlumotlari boʻyicha</th>
                    </tr>
                    <tr>
                        <th>inventar</th>
                        <th>zavod</th>
                        <th>0Pasporti boʻyicha</th>
                        <th>soni</th>
                        <th>qiymati, soʻm</th>
                        <th>soni</th>
                        <th>qiymati, soʻm</th>
